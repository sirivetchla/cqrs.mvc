...
namespace Hotel.CQRS.Commands
{
    public class CreateCommand:Command
    {
        ...
        public CreateCommand(Guid aggregateId,string customerName,string email, string phoneNo,int roomNo,int version, DateTime checkIn, DateTime checkOut, bool isCheckedIn)
